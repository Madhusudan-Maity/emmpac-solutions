...
${formData.message}
    ...
    const mailtoLink = `mailto:emmpacsolutions@gmail.com?subject=${encodeURIComponent(
      formData.subject
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                          8877000030, 8116915768, 9073374695, 9771417252
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                          emmpacsolutions@gmail.com
                        </p>
                        <p className="text-gray-700 dark:text-gray-300">
                          <a
                            href="https://www.emmpacsolutions.com"
                            className="text-[#4169E1] hover:underline"
                          >
                            www.emmpacsolutions.com
                          </a>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="pt-2 md:hidden">
                      <h3 className="text-lg font-medium mb-3 text-[#4169E1] dark:text-[#2cf0c1]">
                        Office Locations
                      </h3>
                      <div className="grid grid-cols-1 gap-6">
                        <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          ...
                          <p className="text-gray-700 dark:text-gray-300 md:hidden">
                            Sansar Plaza, near Bhagat Singh More, J K College Road, Purulia - 723101
                          </p>
                        ...
                        <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          ...
                          <p className="text-gray-700 dark:text-gray-300 md:hidden">
                            Sumami Enterprise, Thakdari Road, CG Block, Action Area-1, New Town, Kolkata - 700156
                          </p>
                          <div className="mt-3 overflow-hidden rounded-md md:hidden">
                            <iframe
                        ...
                        <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          ...
                          <p className="text-gray-700 dark:text-gray-300 md:hidden">
                            #3C, Lakshmi Savitri Apartment, Tiwari Tank Road, Hindpiri, Ranchi, Jharkhand
                          </p>
                          <div className="mt-3 overflow-hidden rounded-md md:hidden">
                            <iframe
      ...
      <AnimatedSection delay={0.2}>
        <section className="py-6 bg-white dark:bg-gray-900 hidden md:block">
          <div className="container mx-auto px-4 max-w-6xl">
            <h3 className="text-2xl font-semibold mb-6 text-[#4169E1] dark:text-[#2cf0c1]">
              Office Locations
            </h3>
